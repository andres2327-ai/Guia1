...
namespace Guia1
{
    public class Ejercicio_1
    {
        ...
        {
            Console.SetCursorPosition(8, 6); Console.WriteLine("repote de Notas");
            ...
            Console.SetCursorPosition(36, 10); Console.Write(nota2);
            ...
            Console.SetCursorPosition(40, 12); Console.WriteLine("Estado : " + Estado());
